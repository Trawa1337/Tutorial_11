    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "k.zielinska@clinic.pl", "Katarzyna", "Zielińska" },
                    { 2, "t.lewandowski@clinic.pl", "Tomasz", "Lewandowski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Na przeziębienie", "Polopiryna", "Tabletka" },
                    { 2, "Wzmacniający odporność", "Rutinoscorbin", "Tabletka" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1975, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Adam", "Wiśniewski" },
                    { 2, new DateTime(1988, 11, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ewa", "Kaczmarek" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Raz dziennie po posiłku", 1 },
                    { 2, 2, "Dwa razy dziennie przed snem", 2 }
                });
